%% Global tree recovery version 4
...
[~,~,input]=xlsread('.\data_NDVI.csv');
[~,~,result]=xlsread('.\resul_NDVI.csv');
...
cl2=[2 1 2 2 5 3 2 4 3 4 3 5 3 4 4 4 5 4 3];
axes('position',[0.12 0.57 0.20 0.40],'linewidth',0.8,'box','on')
tt={'MAT', 'Mortality severity', 'T in RT', 'P in RT', 'Elevation', 'SLA', 'MAP', 'Soil pH', 'Forest age', 'STN', 'Tree density', 'Slope', 'Root depth', 'AWC', 'CEC', 'Soil clay', 'Aspect', 'Soil bulk density', 'Forest height'};
for i=1:19
    cc=cl2(20-i);
    barh(i,sh_v2(20-i),'facecolor',col(cc,:),'edgecolor','none');hold on
    ...
    text(k2-0.0035,20-i,cellstr(tt(i)),'fontsize',10);
    set(gca,'ytick',[]);
end
xlabel('Mean (|SHAP| value)');
text(-0.03,20,'a','fontsize',12,'fontweight','b')
rectangle('position',[0.042 5 0.01 0.8],'facecolor',col(1,:),'edgecolor','none');
text(0.054,5.4,'Mortality','fontsize',10);

rectangle('position',[0.042 4 0.01 0.8],'facecolor',col(2,:),'edgecolor','none');
text(0.054,4.4,'Climate','fontsize',10);

rectangle('position',[0.042 3 0.01 0.8],'facecolor',col(3,:),'edgecolor','none');
text(0.054,3.4,'Vegetation','fontsize',10);

rectangle('position',[0.042 2 0.01 0.8],'facecolor',col(4,:),'edgecolor','none');
text(0.054,2.4,'Soil','fontsize',10);

rectangle('position',[0.042 1 0.01 0.8],'facecolor',col(5,:),'edgecolor','none');
text(0.054,1.4,'Topography','fontsize',10);
set(gca,'linewidth',0.5,'fontsize',10);
xlim([0 0.09])
set(gca,'xtick',0:0.02:0.12);
set(gca,'linewidth',0.5,'fontsize',10);
%
axes('position',[0.6 0.79 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,1));
yy=cell2mat(result(2:end,2));
plot(xx,yy,'.','markersize',8,'color',col(1,:));
xlabel('Mortality severity (%)', 'Position', [55, -0.5]);
ylabel('SHAP value', 'Position', [-20, 0]);
text(-25.5,0.4,'c','fontsize',12,'fontweight','b')
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.81 0.79 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,9));
yy=cell2mat(result(2:end,6));
plot(xx,yy,'.','markersize',8,'color',col(2,:));
xlabel('T in RT (^{o}C)','Position', [1, -0.36]);
ylabel('SHAP value', 'Position', [-6.05, 0]);
set(gca,'linewidth',0.5,'fontsize',10);
line([-4 6],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-6.6,0.3,'d','fontsize',12,'fontweight','b')
...
%
axes('position',[0.39 0.79 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,3));
yy=cell2mat(result(2:end,4));
plot(xx,yy,'.','markersize',8,'color',col(2,:));
xlabel('MAT (^{o}C)','Position', [10, -0.37]);
ylabel('SHAP value','Position', [-18.45, 0]);
set(gca,'linewidth',0.5,'fontsize',10);
line([-10 30],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-20,0.3,'b','fontsize',12,'fontweight','b')
set(gca,'ytick',-0.3:0.1:0.3);
ylim([-0.3 0.3])
xlim([-10 30])
set(gca,'linewidth',0.5,'fontsize',10);
...
%
axes('position',[0.6 0.55 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,28));
yy=cell2mat(result(2:end,18));
plot(xx,yy,'.','markersize',8,'color',col(5,:));
xlabel('Elevation (m)');
ylabel('SHAP value');
text(-975,0.2,'f','fontsize',12,'fontweight','b')
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.39 0.55 0.14 0.18],'linewidth',0.8,'box','on')
...
text(-0.69,0.4,'e','fontsize',12,'fontweight','b')
ylim([-0.4 0.4])
set(gca,'linewidth',0.5,'fontsize',10);
xlim([-0.4 0.8]);
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.81 0.55 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,23));
yy=cell2mat(result(2:end,15));
plot(xx,yy,'.','markersize',8,'color',col(3,:));
xlabel('SLA (cm^{2} g^{-1})', 'Position', [15, -0.375]);
ylabel('SHAP value');
set(gca,'linewidth',0.5,'fontsize',10);
line([5 25],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-0.1,0.3,'g','fontsize',12,'fontweight','b')
ylim([-0.3 0.3])
xlim([5 25])
set(gca,'ytick',-0.3:0.1:0.3);
set(gca,'linewidth',0.5,'fontsize',10);
...
%
clear
[~,~,input]=xlsread('.\data_NDII.csv');
[~,~,result]=xlsread('.\resul_NDII.csv');
...
set(gcf,'paperpositionmode','auto','position',[10 20  1200 900]);
col=[200 80 90;120 180 220;80 180 125;254 160 150;190 190 190]/255;
cl2=[2 2 2 3 1 5 2 3 5 4 5 4 4 3 4 3 4 3 4];
axes('position',[0.12 0.07 0.20 0.4],'linewidth',0.8,'box','on')
tt={'P in RT', 'MAT', 'T in RT', 'SLA', 'Mortality severity', 'Elevation', 'MAP', 'Tree density', 'Slope', 'AWC', 'Aspect', 'Soil pH', 'STN', 'Forest age', 'Soil bulk density', 'Forest height', 'CEC', 'Root depth', 'Soil clay'};
for i=1:19
    cc=cl2(20-i);
    barh(i,sh_v2(20-i),'facecolor',col(cc,:),'edgecolor','none');hold on
    kl=strlength(cellstr(tt(i)));
    ...
    text(k2-0.003,20-i,cellstr(tt(i)),'fontsize',10);
    set(gca,'ytick',[]);
end
xlabel('Mean (|SHAP| value)');
text(-0.03,20,'h','fontsize',12,'fontweight','b')
rectangle('position',[0.042 5 0.01 0.8],'facecolor',col(1,:),'edgecolor','none');
text(0.054,5.4,'Mortality','fontsize',10);
...
%
%
axes('position',[0.6 0.29 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,3));
yy=cell2mat(result(2:end,4));
plot(xx,yy,'.','markersize',8,'color',col(2,:));
xlabel('MAT (^{o}C)', 'Position', [10, -0.73]);
ylabel('SHAP value');
ylim([-0.6 0.6])
xlim([-10 30])
text(-19.8,0.6,'j','fontsize',12,'fontweight','b')
line([-10 30],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
...
%
axes('position',[0.39 0.29 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,8));
yy=cell2mat(result(2:end,5));
plot(xx,yy,'.','markersize',8,'color',col(2,:));
xlabel('P in RT (%)', 'Position', [0.2, -0.76]);
ylabel('SHAP value', 'Position', [-0.65, 0]);
set(gca,'linewidth',0.5,'fontsize',10);
line([-0.4 0.8],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-0.68,0.6,'i','fontsize',12,'fontweight','b')
set(gca,'ytick',-0.6:0.2:0.6);
ylim([-0.6 0.6])
xlim([-0.4 0.8])
set(gca,'xtick',-0.4:0.2:0.8,'xticklabel',-40:20:80);
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.81 0.29 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,9));
yy=cell2mat(result(2:end,6));
plot(xx,yy,'.','markersize',8,'color',col(2,:));
xlabel('T in RT (^{o}C)', 'Position', [1, -0.48]);
ylabel('SHAP value');
set(gca,'linewidth',0.5,'fontsize',10);
line([-4 6],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-6.5,0.4,'k','fontsize',12,'fontweight','b')
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.6 0.05 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,1));
yy=cell2mat(result(2:end,2));
plot(xx,yy,'.','markersize',8,'color',col(1,:));
xlabel('Mortality severity (%)', 'Position', [50, -0.255]);
ylabel('SHAP value', 'Position', [-18.8, 0]);
text(-27.8,0.2,'m','fontsize',12,'fontweight','b')
line([0 100],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
ylim([-0.2 0.2])
xlim([0 100])
set(gca,'linewidth',0.5,'fontsize',10);
...
axes('position',[0.81 0.05 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,28));
yy=cell2mat(result(2:end,18));
plot(xx,yy,'.','markersize',8,'color',col(5,:));
xlabel('Elevation (m)', 'Position', [2000, -0.25]);
ylabel('SHAP value', 'Position', [-750, 0]);
set(gca,'linewidth',0.5,'fontsize',10);
line([0 4000],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(-1000,0.2,'n','fontsize',12,'fontweight','b')
ylim([-0.2 0.2])
xlim([0 4000]);
set(gca,'linewidth',0.5,'fontsize',10);
...
xconf = [xx2 xx2(end:-1:1)] ;%构造正反向的x值，作为置信区间的横坐标值
 ...
 alpha(pp,0.3)
%
axes('position',[0.39 0.05 0.14 0.18],'linewidth',0.8,'box','on')
xx=cell2mat(input(2:end,23));
yy=cell2mat(result(2:end,15));
plot(xx,yy,'.','markersize',8,'color',col(3,:));
xlabel('SLA (cm^{2} g^{-1})', 'Position', [15, -0.373]);
ylabel('SHAP value', 'Position', [0.75, 0]);
set(gca,'linewidth',0.5,'fontsize',10);
line([5 25],[0 0],'linestyle','--','linewidth',0.6,'color',[0.6 0.6 0.6]);
text(0.25,0.3,'l','fontsize',12,'fontweight','b')
ylim([-0.3 0.3])
xlim([5 25])
set(gca,'ytick',-0.3:0.1:0.3);
set(gca,'linewidth',0.5,'fontsize',10);
...
%print(gcf,'-djpeg','-r300','.\Fig3');
%print(gcf,'-dtiff','-r600','.\Fig3');
%% Figure 4 RT_T P 的变化
